...
<td align="center" style="padding: 2rem"> <!-- Add your logo in the footer -->
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p><a href="expo://u.expo.dev/a0f2881c-1533-4457-bd87-e4dd58776651?channel-name=preview&runtime-version=exposdk:49.0.0&screen=NewPassword&resetToken=${resetToken}" style="background-color: #E3735E; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px; display: inline-block;">Reset Password</a></p>
